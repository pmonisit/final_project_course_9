...
def show_exam_result(request, course_id, submission_id):
    ...
    for selected in submission.chocies.all():
        selected_ids.append(selected.pk)
    ...
    for question in questions:
        ...
        for choice in choices:
            if choice.is_correct == True:
                correct.append(choice.pk)
            if choice.is_correct == False and choice.id in selected_ids:
                failed = True

        if set(correct).issubset(selected_ids) and not failed:
